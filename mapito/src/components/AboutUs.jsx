...
const AboutUs = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      title: "Smart Quizzes",
      description: "Test your knowledge with adaptive quizzes that evolve with your learning journey"
    },
    {
      icon: <FaKeyboard className="text-3xl text-gray-400" />,
      title: "Typing Test",
      description: "Measure and improve your typing speed and accuracy with real-time charts and wmp calculation"
    },
    {
      icon: <FaStickyNote className="text-3xl text-gray-400" />,
      title: "Summarize Notes",
      description: "Use AI to instantly generate concise summaries from your developer documentation for quick revision"
    },
    {
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 mb-10 md:mb-0">
                ...
                <p className="text-gray-600 mb-6">
                  Whether you're preparing for switching into tech careers, learning new technologies, or sharpening your skills,
