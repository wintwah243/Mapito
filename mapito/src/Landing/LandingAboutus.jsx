  ...
  const features = [
    {
      ...
      description: "Get step-by-step learning paths based on your goals or career path"
    },
    {
    ...
    },
    {
      ...
      description: "Use AI to instantly generate concise summaries from developer documentations for quick revision"
    },
    {
      ...
      <div className="mt-9 min-h-screen bg-gray-50">
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-6 text-center">
            ...
            <button onClick={() => navigate("/signup")} className="px-8 py-4 bg-blue-600 text-white rounded-lg transition duration-300 text-lg font-semibold">
