...
export const quizData = {
    ...
    java: [
      ...
      },
      {
        ...
        options: ["String", "char", "text", "int"],
        answer: "String"
      },
      {
        question: "What does JVM stand for?",
        options: ["Java Variable Method", "Java Virtual Machine", "Java Verified Mode", "None"],
    ...
    php: [
      {
        ...
        options: ["Personal Home Page", "Preprocessed Hypertext Page", "PHP: Hypertext Preprocessor", "Private Hosting Processor"],
    ...
    ai: [
      ...
      {
        question: "What does 'training a model' mean in AI?",
        options: [
